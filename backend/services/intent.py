...
segment (a student aside, not a sentence of lecture) that also carries an
explicit trigger phrase. The segment is still appended to the transcript
that feeds extraction - a command is never swallowed.
"""
import re
